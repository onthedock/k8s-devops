# Automatiza la creación de usuarios (método nativo de Kubernetes 1.19+)

Todos los pasos descritos en [Creación de un usuario en K8s (método nativo de Kubernetes 1.19+)](crear-usuario-en-k8s-metodo-nativo-de-k8s.md) se recogen en este *script*: `automate.sh` [^1];
...
[^1]: A fecha 05/12/2021. La última versión, en el repo de Github [onthedock/k8s-devops](https://github.com/onthedock/k8s-devops)
